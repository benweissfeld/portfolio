    ...
    <>
      ...
      <TweaksPanel title="Tweaks">
        ...
        <TweakSection label="Typography">
          <TweakSelect label="Type pair" value={t.type}
            options={[
              { value: 'neo',        label: 'Geist · default' },
              { value: 'editorial',  label: 'Instrument Serif · editorial' },
              { value: 'swiss',      label: 'Helvetica · swiss' },
              { value: 'mono',       label: 'JetBrains Mono · raw' },
        ...
        <TweakSection label="Layout">
          <TweakSelect label="Hero layout" value={t.heroLayout}
            options={[
              ...
              { value: 'split',     label: 'Split with portrait' },
